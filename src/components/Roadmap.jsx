...
const Roadmap = () => {
  ...
  return (
    <section id="roadmap" className="py-20 lg:py-32 bg-gray-50 dark:bg-gray-900/50 backdrop-blur-sm transition-colors duration-500">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            return (
              <div key={index} className="relative pl-12">
                ...
                {index < milestones.length - 1 && (
                  <div className={`absolute left-6 top-12 bottom-0 w-1 bg-gradient-to-b ${milestone.color}`}></div>
                )}

                {/* Point */}
                <div className="absolute left-0 top-0">
                  <div className={`w-12 h-12 bg-gradient-to-br ${milestone.color} rounded-full flex items-center justify-center shadow-lg`}>
                    <Icon className={`w-6 h-6 ${milestone.status === 'in-progress' ? 'text-white' : 'text-white/70'}`} />
                  </div>
                </div>

                {/* Content */}
                <div className="bg-white dark:bg-gray-800/50 backdrop-blur-lg rounded-2xl p-6 shadow-lg border border-gray-200/50 dark:border-gray-700/50">
                  <div className={`inline-block px-3 py-1 bg-gradient-to-r ${milestone.color} text-white text-sm rounded-full font-bold mb-3`}>
                    {milestone.year} • {milestone.quarter}
                  </div>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-2xl p-6 text-center text-white shadow-xl">
            <div className="text-4xl font-bold mb-2">6 Yıl</div>
            <div className="text-emerald-100">Stratejik Planlama</div>
          </div>
          <div className="bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl p-6 text-center text-white shadow-xl">
            ...
            <div className="text-blue-100">Müşteri Hedefi</div>
          </div>
          <div className="bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl p-6 text-center text-white shadow-xl">
            <div className="text-4xl font-bold mb-2">117M TL</div>
            <div className="text-purple-100">Gelir Hedefi</div>
          </div>
        </div>
      </div>
    </section>
